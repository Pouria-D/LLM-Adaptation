...
AUTO_MODELS = {
    ...
    TaskType.SEQUENCE_CLASSIFICATION: BertForSequenceClassification, #AutoModelForSequenceClassification,changed  
    # changed to use local bert to modify model for lora
...
def get_model(model_args, task_type: TaskType, config: AutoConfig, fix_bert: bool = False):
    if model_args.method_type == 'prefix':
        ...
        # Function to count the total number of trainable parameters
