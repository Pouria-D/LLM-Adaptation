...
class LoRALayer(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return (self.alpha / torch.sqrt(torch.tensor(self.rank).float())) * lora_out
...
def apply_lora(model):
    ...
    for layer in model.encoder.layer:
        ...
        layer.attention.self.key = assign_lora(layer.attention.self.query)
        layer.attention.self.value = assign_lora(layer.attention.self.query)
